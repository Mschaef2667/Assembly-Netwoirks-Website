...
const TOUR_STEPS: TourStep[] = [
  {
    ...
    body: 'Six stages each building on the last. Journey Progress shows exactly where your strategy stands at a glance.',
    position: 'bottom',
  },
  {
    page: '/dashboard',
    ...
    body: 'Gates require leadership sign-off before messaging moves forward. Governance is built into the platform.',
    position: 'top',
  },
  {
    page: '/dashboard',
    ...
    body: 'A real-time measure of how complete and battle-ready your go-to-market strategy is. Watch this number climb.',
    position: 'left',
  },
  {
    ...
    body: 'Build a Decision Clarity Process survey to understand exactly how your buyers decide — not just what they buy.',
    position: 'bottom',
  },
  {
    page: '/dashboard/intelligence',
    ...
    title: 'The Buyer Map',
    body: 'Assembly AI analyzes responses across all seven buying stages and builds a behavioral map of your buyer. Gate 1 must be approved before strategy begins.',
    position: 'bottom',
  },
  {
    page: '/dashboard/target-markets',
    targetId: 'target-markets-segments',
    title: 'Know Who You Are Writing For',
    body: 'Define your market segments and generate complete Ideal Customer Profiles grounded in your DCP data not assumptions.',
    position: 'right',
  },
  {
    page: '/dashboard/journeys/step/4',
    targetId: 'step-pain-points',
    title: 'Three Real Problems',
    body: 'These are the endemic problems your buyers actually experience surfaced from real survey data. Every downstream step is linked to these three pain points.',
    position: 'right',
  },
  {
    page: '/dashboard/journeys/step/11',
    targetId: 'step-cvp',
    title: 'AI-Powered Value Propositions',
    body: 'Watch the AI write a compelling value proposition specific to this buyer this pain point this company. Not generic. Not interchangeable.',
    position: 'right',
  },
  {
    ...
    body: 'Assembly AI searches the live web to find your competitors right now. Known players adjacent tools and emerging threats all organized by relevance.',
    position: 'right',
  },
  {
    ...
    body: 'Every approved step compiled into one document. Download as PDF or Word. This used to cost 50,000 dollars and six months of consulting work.',
    position: 'bottom',
  },
]
