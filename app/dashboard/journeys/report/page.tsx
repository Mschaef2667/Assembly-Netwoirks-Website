...
function ReportPageInner() {
  ...
  async function handleDocx() {
    ...
    try {
      ...
      children.push(new Paragraph({ children: [new TextRun({ text: 'C3 Method Engagement Plan', bold: true, size: 36 })], spacing: { after: 200 } }))
      ...
      const doc = new Document({
        creator: 'Assembly AI',
        title: `${org?.name ?? 'Your Company'} — C3 Method Engagement Plan`,
  ...
  async function handleFutureStateDocx() {
    ...
    try {
      ...
      children.push(para(lib, 'This Future State Strategic Plan is the companion to the current state Engagement Plan. While the current state plan describes the actions to take today based on what is true, this plan describes the 6-18 month strategic agenda to close capability gaps, capture market opportunities, neutralize competitive threats, and reposition the brand to align with how buyers actually evaluate solutions.'))
                ...
                <div style={{ padding: '0 32px 40px', display: 'flex', justifyContent: 'center' }}>
                  ...
                  >
                    ...
                    <div style={{ padding: '48px 48px 20px' }}>
                      ...
                      <p style={bodyStyle}>
                        This Future State Strategic Plan is the companion to the current state Engagement Plan. While the current state plan describes the actions to take today based on what is true, this plan describes the 6-18 month strategic agenda to close capability gaps, capture market opportunities, neutralize competitive threats, and reposition the brand to align with how buyers actually evaluate solutions.
                      </p>
                      <p style={bodyStyle}>
